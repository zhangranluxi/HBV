...
#mycolors <- c("#53868B", "#8B0A50", "#9ACD32", "#8B4513")
...
taxcolors <- c(brewer.pal(n=9, name="Set1"), brewer.pal(n=8, name="Set2"))
...
pointdat$groups <- factor(pointdat$groups, levels=c("Healthy", "HBVI", "CHB", "LC"))
p2 <- ggplot(pointdat) +
